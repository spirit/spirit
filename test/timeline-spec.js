...
describe('timeline', () => {
  ...
  describe('type is Object', () => {
    it('should allow nullable transform object', async () => {
      expect(() => new Timeline('object')).not.to.throw(
  ...
  describe('validate', () => {
    it('should validate element', () => {
      ...
      expect(() => {
        tl.transformObject = 123;
      }).to.throw(/transformObject needs to be an element/);
      expect(() => {
        tl.transformObject = null;
      }).not.to.throw();
      expect(() => {
        tl.transformObject = document.createElement('div');
      }).not.to.throw();
    });
    ...
    it('should validate object', () => {
      ...
      expect(() => {
        tl.transformObject = 123;
      }).to.throw(/transformObject needs to be an object/);
      expect(() => {
        tl.transformObject = null;
      }).not.to.throw();
      expect(() => {
  ...
  describe('apply mappings to props', () => {
    describe('as object', () => {
      ...
      it('should apply this mapping for keyframes to add', () => {
        const keyframe = tl.props
          .get('total')
          .keyframes.add({ '3s': { value: '{ this.foo + this.bar }' } });
